...
$page = 1;
if (isset($_GET["page"]) && preg_match("/^\d+$/", $_GET["page"]))$page = (int)$_GET["page"];
...
$allCountries = getCountriesByPage($db, $page); // remplacement par getCountriesByPage

$pagination = paginationModel($_SERVER['REQUEST_URI'], "page", $nbPays, $page, 20);
